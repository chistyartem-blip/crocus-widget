...
function renderBadge(result){
  if(!result){
    return '<span class="crw3__master-slot-dot grey"></span>'
      + '<span style="color:rgba(255,255,255,0.55);font-size:10.5px;">Auf Anfrage</span>';
  }
  ...
  return dot + '<span style="font-size:10.5px;color:rgba(255,255,255,0.90);">' + timeStr + '</span>';
}
