      ...
      + '<div class="cw-step" id="cw-gift2">'
        ...
        + '<form class="cw-form" id="cw-gift-form">'
          ...
          + '<div class="cw-gift-info-box">'
            ...
            + '<p>Nach Ihrer Anfrage melden wir uns per E-Mail und stimmen die Zahlung ab — bar oder per Überweisung, ganz wie es für Sie passt.</p>'
          + '</div>'
          + '<button type="submit" class="cw-btn-confirm" id="cw-gift-submit">Gutschein anfragen →</button>'
          + '<p class="cw-form-note">Keine Vorauszahlung · Wir melden uns innerhalb 24 Stunden</p>'
        + '</form>'
      + '</div>'
